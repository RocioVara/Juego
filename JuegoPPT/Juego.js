...
function ganar(opcionUser, opcionPc){
  ...
  result_div.innerHTML= convertirLetra(opcionUser)+smallUser+" gana a "+convertirLetra(opcionPc)+smallPc+".<br> Ganaste!";
...
function pierda(opcionUser, opcionPc){
  ...
  const smallUser= "(USER)".fontsize(2);
  const smallPc= "(PC)".fontsize(2);
  result_div.innerHTML= convertirLetra(opcionPc)+smallPc+" gana a "+convertirLetra(opcionUser)+smallUser+".<br> Perdiste";
  const userChoice_div= document.getElementById(opcionUser);
  const pcChoice_div= document.getElementById(opcionPc);
...
function empate(opcionUser){
  result_div.innerHTML= "Ambos escogieron: "+convertirLetra(opcionUser)+".<br> Empate";
